...
export default ({ onAttempt, useNativePrompt, title, description }) => {
  if (useNativePrompt) {
    title = title || 'Authentication';
    description = description || 'Unlock app';
    return ReactNativeFingerprintScanner.confirmDeviceCredential(title, description)
      .catch((error) => {
